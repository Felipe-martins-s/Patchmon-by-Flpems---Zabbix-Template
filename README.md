...
GET
{$PM_URL}/api/v1/api/hosts GET {$PM_URL}/api/v1/api/hosts/{#PM_HOSTID}/integrations\
GET
{$PM_URL}/api/v1/api/hosts/{#PM_HOSTID}/info GET {$PM_URL}/api/v1/api/hosts/{#PM_HOSTID}/system\
